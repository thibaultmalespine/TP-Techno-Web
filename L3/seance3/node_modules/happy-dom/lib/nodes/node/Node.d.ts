...
export default class Node extends EventTarget implements INode {
    static [PropertySymbol.ownerDocument]: IDocument | null;
    ...
    [PropertySymbol.ownerDocument]: IDocument;
    [PropertySymbol.parentNode]: INode | null;
    ...
    [PropertySymbol.textAreaNode]: INode;
    [PropertySymbol.observers]: MutationListener[];
    [PropertySymbol.childNodes]: INodeList<INode>;
    /**
     * Constructor.
     */
    constructor();
